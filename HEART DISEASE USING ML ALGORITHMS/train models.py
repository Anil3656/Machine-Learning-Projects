...
# Load your dataset
df = pd.read_csv(r'D:\Data Science Daily Updates\Senapthi_calss_Notes\MACHINE LEARNING CLASS\Machine Learning CAPSTONE PROJECT\HEART DISEASE USING ML ALGORITHMS\heart_disease_uci.csv')
print(df.head())
