...
app = Flask(__name__)
model = joblib.load(r"D:\Data Science Daily Updates\Senapthi_calss_Notes\MACHINE LEARNING CLASS\Student mark Predictor Deployment\student_mark_predictor.pkl")
