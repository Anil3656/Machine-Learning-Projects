...
model = joblib.load(r"D:\Data Science Daily Updates\Senapthi_calss_Notes\MACHINE LEARNING CLASS\Machine Learning CAPSTONE PROJECT\CUSTOMER CHURN\Customer_churn_project\final_gb_classifier.pkl")
